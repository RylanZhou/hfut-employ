    ...
    wx.request({
      ...
      success: function(res) {
        ...
        if (data.r > 0) {
          that.setData({
            id: data.Skill.ID,
            getdate: data.Skill.GetDate,
            skillkind: data.Skill.SkillKind,
            caption: data.Skill.Caption,
            isTouchMove: data.Skill.isTouchMove
          })
        }
        wx.hideLoading()
      },
    ...
    wx.showModal({
      ...
      success: function(res) {
        if (res.confirm) {
          wx.request({
            url:
              app.api.baseUrl + app.Graduate.code + '/Graduate/Mine/Skill.ashx',
            data: {
              action: 'deleted',
              code: app.Graduate.code,
              gid: app.Graduate.gid,
            ...
            success: function(res) {
              ...
              const tmpskillkind = that.data.skillkind
